...
%
% output:
% SegI      --   the segmented image
% JSEG: 4.2 step4
% Unclassified pixels at the region boundaries are stored in a buffer(heap)
% in our cse. Each time, the pixel with the minimum local J value is
% assigned to the adjacent region. And the buffer is updated until all the

% region growing on Binary image BI
% given the seeds, find the segments with size larger than minsize.
% also called valley
% input: 
% BI              --  original image
% [seedx, seedy]  --  the seeds' positions 
% minsize         --  1-4 corresponding to [32, 128, 512, 2048];
% output: Seg     --  segments with numbers as label
